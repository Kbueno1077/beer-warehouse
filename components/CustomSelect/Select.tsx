...
const customStyles: StylesConfig<OptionsType, true> = {
    ...
    control: (styles, state) => ({
        ...styles,
        backgroundColor:
            state.selectProps.theme === DARK_MODE ? "#27272A" : "#F4F4F5",
        minHeight: "56px",
        cursor: "pointer",
        height: "max-content",
        borderRadius: "10px",
        ...
        ":hover": {
            backgroundColor:
                state.selectProps.theme === DARK_MODE ? "#3F3F46" : "#E4E4E7",
        },
    }),
...
const CustomOption = ({
    ...
    const newDecoration = {
        ...
        props: {
            ...decoration.props,
            src: `https://flagcdn.com/${data.value}.svg`,
        },
    };
...
const CustomMultiValue = ({
    children,
    ...props
}: MultiValueProps<OptionsType, false>) => {
    const {
        decoration,
...
const CustomSingleValue = ({
    children,
    ...props
}: SingleValueProps<OptionsType, false>) => {
    const {
        decoration,
        decorationPlacement = "start",
        value,
