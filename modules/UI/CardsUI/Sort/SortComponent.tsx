...
import {BiSolidDownArrowAlt, BiSolidUpArrowAlt, BiSortAZ, BiSortZA} from "react-icons/bi";
...
export default function SortComponent({handleSort, selectedSort}: any) {
    ...
    return (<><Button onPress={() => {
        handleSort({attribute: 'country', direction: 'up'})
                      ...
                      variant={selectedSort.attribute === 'country' && selectedSort.direction === 'up' ? 'bordered' : 'faded'}
                      isIconOnly
        ...
        <Button onPress={() => {
            handleSort({attribute: 'country', direction: 'down'})
                ...
                color='primary'
                variant={selectedSort.attribute === 'country' && selectedSort.direction === 'down' ? 'bordered' : 'faded'}
                isIconOnly
        ...
        <Button onPress={() => {
            handleSort({attribute: 'name', direction: 'up'})
                ...
                variant={selectedSort.attribute === 'name' && selectedSort.direction === 'up' ? 'bordered' : 'faded'}
                isIconOnly
        ...
        <Button onPress={() => {
            handleSort({attribute: 'name', direction: 'down'})
                ...
                variant={selectedSort.attribute === 'name' && selectedSort.direction === 'down' ? 'bordered' : 'faded'}
                isIconOnly
        ...
        <Button onPress={() => {
            handleSort({attribute: 'alcohol_percentage', direction: 'up'})
        }} color='primary'
                variant={selectedSort.attribute === 'alcohol_percentage' && selectedSort.direction === 'up' ? 'bordered' : 'faded'}
                aria-label="ABV Up">
            {t('abv')} <BiSolidUpArrowAlt/>
        </Button>

        <Button onPress={() => {
            handleSort({attribute: 'alcohol_percentage', direction: 'down'})
        }} color='primary'
                variant={selectedSort.attribute === 'alcohol_percentage' && selectedSort.direction === 'down' ? 'bordered' : 'faded'}
                aria-label="ABV Down">
        ...
        <Button onPress={() => {
            handleSort({attribute: 'ml', direction: 'up'})
                ...
                variant={selectedSort.attribute === 'ml' && selectedSort.direction === 'up' ? 'bordered' : 'faded'}
                aria-label="ML Up">
        ...
        <Button onPress={() => {
            handleSort({attribute: 'ml', direction: 'down'})
                ...
                variant={selectedSort.attribute === 'ml' && selectedSort.direction === 'down' ? 'bordered' : 'faded'}
                aria-label="ML Down">
        ...
        <Button onPress={() => {
            handleSort({attribute: 'bought_in', direction: 'up'})
                ...
                variant={selectedSort.attribute === 'bought_in' && selectedSort.direction === 'up' ? 'bordered' : 'faded'}
        ...
        <Button onPress={() => {
            handleSort({attribute: 'bought_in', direction: 'down'})
                ...
                variant={selectedSort.attribute === 'bought_in' && selectedSort.direction === 'down' ? 'bordered' : 'faded'}
