        ...
        <div className='flex flex-col gap-5 m-3 md:m-10'>
            <div className='flex flex-col md:flex-row justify-evenly gap-5'>
                ...
                <div className='flex flex-col gap-2'>
                    <h1 className="mb-5 lg:ml-[-40px] text-4xl font-extrabold leading-none tracking-tight md:text-5xl lg:text-6xl">{beer.name}</h1>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex gap-2 items-center'>
                        ...
                        <span className={'font-normal'}>{beer.alcohol_percentage} {t('abv')}</span>
                    </div>


                    <div className='flex gap-2 items-center'>
                        <p className="text-2xl font-bold">{t('impression')}</p>
                        <span className={'font-normal'}>{beer.initial_impression} </span>
                    </div>
                    ...
                    <div className='flex gap-2 items-center'>
                        <p className="text-2xl font-bold">Bought In:
                        </p>
