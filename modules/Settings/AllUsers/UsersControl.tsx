...
import {Accordion, AccordionItem, Avatar, Select, SelectItem} from "@nextui-org/react";
    ...
    return (
        <Accordion fullWidth={true} variant="splitted">
            ...
            >
                ...
                <Input className='mb-3' fullWidth={true} variant={'flat'} label="Name"/>
                <Input className='mb-3' fullWidth={true} type="email" variant={'flat'} label="Email"/>
