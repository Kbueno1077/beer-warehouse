...
const nextConfig = withNextIntl({
    images: {
        domains: ['images.hdqwalls.com', "source.unsplash.com", 'res.cloudinary.com'],
    },
    env: {
        XATA_BRANCH: "main",
        XATA_API_KEY: "xau_0I1txF4W10ujyhpbjiqpNKazZNqpKymk0",
        XATA_DB_URL: "https://Kevin-Bueno-s-workspace-8l3c94.us-east-1.xata.sh/db/beer-warehouse",
        ...
        CLOUDINARY_BEER_FOLDER: "beers-cloudStore",
